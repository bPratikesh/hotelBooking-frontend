    ...
    <>
      <section className="space-y-4">
        ...
        <div className="flex items-center gap-2 px-2">
          <CornerDownRightIcon size={14} className="-mt-4 stroke-gray-400" />
        ...
        <div className="text-orange-500 bg-orange-50 flex gap-1 p-2 items-center border rounded-sm">
          ...
          <p className="text-sm font-medium">
            Located less than 5 Km from Medanata Hospital | Located 3 Kms from
            Omaxe Mall
          </p>
        </div>
      </section>
        ...
        <ul className="flex flex-wrap gap-2">
          {hotel.amenities.map((item, index) => (
            <li key={index} className="flex gap-2 items-center min-w-[180px]">
              <Icon icon="check" size="18" className="text-green-400" />
